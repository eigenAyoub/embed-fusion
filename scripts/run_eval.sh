...
for ep in {1..15}; do
    ...
    python eval.py "$1" NFCorpus 1 "$2_ep_0${ep}_$3" 384 0 x "$3-384-$ep"   
    python eval.py "$1" SciFact  1 "$2_ep_0${ep}_$3" 384 0 x "$3-384-$ep"   
    python eval.py "$1" ArguAna  1 "$2_ep_0${ep}_$3" 384 0 x "$3-384-$ep"   
